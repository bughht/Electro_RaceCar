...
(cl:defmethod cl:initialize-instance :after ((m <status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raceworld-msg:<status> is deprecated: use raceworld-msg:status instead.")))

(cl:ensure-generic-function 'leader-val :lambda-list '(m))
(cl:defmethod leader-val ((m <status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raceworld-msg:leader-val is deprecated.  Use raceworld-msg:leader instead.")
  (leader m))

(cl:ensure-generic-function 'follower1-val :lambda-list '(m))
(cl:defmethod follower1-val ((m <status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raceworld-msg:follower1-val is deprecated.  Use raceworld-msg:follower1 instead.")
  (follower1 m))

(cl:ensure-generic-function 'follower2-val :lambda-list '(m))
(cl:defmethod follower2-val ((m <status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raceworld-msg:follower2-val is deprecated.  Use raceworld-msg:follower2 instead.")
  (follower2 m))

(cl:ensure-generic-function 'follower3-val :lambda-list '(m))
(cl:defmethod follower3-val ((m <status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raceworld-msg:follower3-val is deprecated.  Use raceworld-msg:follower3 instead.")
  (follower3 m))

(cl:ensure-generic-function 'follower4-val :lambda-list '(m))
(cl:defmethod follower4-val ((m <status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raceworld-msg:follower4-val is deprecated.  Use raceworld-msg:follower4 instead.")
  (follower4 m))

(cl:ensure-generic-function 'formation-val :lambda-list '(m))
(cl:defmethod formation-val ((m <status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raceworld-msg:formation-val is deprecated.  Use raceworld-msg:formation instead.")
  (formation m))
